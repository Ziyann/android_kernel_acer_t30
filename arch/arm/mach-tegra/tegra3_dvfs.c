...
#define CPU_MILLIVOLTS {\
	800, 825, 850, 875, 900, 912, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1137, 1150, 1200, 1200, 1225};
...
static struct dvfs cpu_dvfs_table[] = {
    ...
    // faking speedo id = 4 if overclocing is enabled
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", lp_cpu_millivolts, 1, 1, KHZ,   204000, 295000, 370000, 428000, 475000,  513000,  579000,  620000,  620000),
#else
	...
	CORE_DVFS("vde", avp_millivolts,    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe", avp_millivolts,    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d", avp_millivolts,     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp", avp_millivolts,    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d", avp_millivolts,     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2", avp_millivolts,    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se", avp_millivolts,     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	
	CORE_DVFS("vde", avp_millivolts,    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe", avp_millivolts,    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d", avp_millivolts,     1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp", avp_millivolts,    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d", avp_millivolts,     1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2", avp_millivolts,    1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se", avp_millivolts,     1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
#else
	...
	CORE_DVFS("host1x", avp_millivolts, 1, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  267000),
	CORE_DVFS("host1x", avp_millivolts, 2, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  267000,  267000,  300000),
...
#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	CORE_DVFS("cbus", avp_millivolts,   1, 1, KHZ,        1, 247000, 304000, 400000, 484000,  520000,  520000,  520000,  520000),
#else
...
#ifdef CONFIG_TEGRA3_LP_CORE_OVERDRIVE
	CORE_DVFS("pll_c", avp_millivolts,  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1066000, 1160000, 1260000, 1260000),
#else
